...
The ECCOFS **vector** fields — the expensive half of the model. Nothing is built; `README.md` says what the source is and
...
deliberate. This repository's rode `6156dcb` (2026-08-31), one of three that
